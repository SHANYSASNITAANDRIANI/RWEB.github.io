...
<nav class="navbar navbar-expand-md bg-dark navbar-dark" >
    <!-- Brand -->
    <a style="margin-left=:20px;" class="navbar-brand" href="<?php echo base_url(); ?>">PORTALKU</a>
    ...
    <div  class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('index.php/profil'); ?>">Profil</a>
            </li>
            
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/ujian/">Ujian</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('index.php/dashboard/about'); ?>">About</a>
            </li>
        </ul>
    </div>
</nav>
...
<legend><h6>Selamat Datang Mahasiswa <?php echo $name; ?></h6></legend>
